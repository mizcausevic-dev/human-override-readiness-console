...
import type { HumanOverrideReadinessExport, PostureOptions } from "./types.js";
...
const HELP = `human-override-readiness - analyze robotics override readiness exports

Usage:
  human-override-readiness <export.json> [--format json|markdown|summary]
...
const payload = JSON.parse(readFileSync(input, "utf8")) as HumanOverrideReadinessExport;
